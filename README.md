...
| --- | --- | --- |
| Generative AI with TensorFlow | Jul 2024 | Trained a Generative Adversarial Network (GAN) to learn the FashionMNIST dataset, to then be capable of generating a new image. |
